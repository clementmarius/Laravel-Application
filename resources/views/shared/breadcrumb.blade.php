<nav class="flex mb-5" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/account"
                       class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Account</a>
                </div>
            </li>
        @endif
        ...
        @elseif(str_contains($_SERVER['REQUEST_URI'],'/crud/'))
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/crud"
                       class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Crud</a>
                </div>
            </li>
        @endif
        ...
        @elseif(str_contains($_SERVER['REQUEST_URI'],'/crud/users'))
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/crud/users"
                       class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Users</a>
                </div>
            </li>
        @endif
        @if(preg_match('/\/dashboard\/crud\/users\/\d+/', $_SERVER['REQUEST_URI']) && !str_contains($_SERVER['REQUEST_URI'],'/edit'))
        ...
        @elseif(preg_match('/\/dashboard\/crud\/users\/\d+/' , $_SERVER['REQUEST_URI']))
            <li>
                <div class="flex items-center">
                    <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                         xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/dashboard/crud/users/{{$user->id}}"
        ...
        @endif
        @if(preg_match('/\/dashboard\/crud\/users\/\d+\/edit/' , $_SERVER['REQUEST_URI']))
        <li>
            <div class="flex items-center">
                <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                     xmlns="http://www.w3.org/2000/svg">
