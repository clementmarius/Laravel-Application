                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <x-text-input  id="name" name="name" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" :value="old('name', $user->name)" required autofocus autocomplete="name" />
