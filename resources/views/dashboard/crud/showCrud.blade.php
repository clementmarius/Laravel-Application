            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div id="carousel" class="relative">
                    <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                        <div class="z-0 duration-700 ease-in-out bg-white dark:bg-gray-800 absolute inset-0 transition-transform transform translate-x-0 z-20">
                            ...
                            <p class="mb-4 text-gray-500 dark:text-gray-400">
                                Create, Read, Update, Delete (or archive) resource of your SaaS. Generally speaking, this part is only viewed by admin.
                            </p>
                            <p class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Where you can go from here :</p>
                            <ul role="list" class="pl-2 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                                <li class="flex space-x-2">
                                    ...
                                    <span class="leading-tight">Blog articles can be listed on the <%= link_to "articles page", dashboard_crud_articles_path, class: "font-medium text-blue-600 dark:text-blue-500 hover:underline" %></span>
                                </li>
                                <li class="flex space-x-2">
                                    <!-- Icon -->
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    ...
                                    <span class="leading-tight">Users can view also viewed on the <%= link_to "users page", dashboard_crud_articles_path, class: "font-medium text-blue-600 dark:text-blue-500 hover:underline" %></span>
                                </li>
                            </ul>
                            <a href="/dashboard/crud/articles" class="inline-flex items-center p-2 font-medium rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">
                                Let's start
