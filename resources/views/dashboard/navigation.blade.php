    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="gap-2 flex items-center justify-start">
                ...
                <button id="toggleSidebarMobile" data-drawer-target="default-sidebar" data-drawer-backdrop="false" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <div class="h-8 mr-3 px-2.5">
                    @include('components/application-logo-dashboard')
                </div>
            </div>
