    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="gap-2 flex items-center justify-start">
                ...
                <button id="toggleSidebarMobile" data-drawer-target="default-sidebar" data-drawer-backdrop="false"
            ...
            <div class="flex items-center">
                ...
                <div
                    class="z-20 z-50 max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700 hidden"
                    id="notification-dropdown"
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1756px, 65px);"
