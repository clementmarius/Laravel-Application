                            ...
                            <div
                                ...
                                <ul role="list" class="pl-2 mb-4 space-y-3 text-gray-500 list-disc dark:text-gray-400">
                                    <li class="flex space-x-2">
                                        ...
                                        <span class="leading-tight">All users can access the <a
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                href="/dashboard/account">account page</a></span>
                                    </li>
                                    @if(auth()->user()->hasRole('admin'))
                                        <li class="flex space-x-2">
                                            ...
                                            <span class="leading-tight">Admin may manage data. See <a
                                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                                    href="/dashboard/crud">CRUD page</a></span>
                                        </li>
                                    @endif
                                </ul>
