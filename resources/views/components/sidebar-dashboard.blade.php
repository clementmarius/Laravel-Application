...
<aside
    id="sidebar"
    class="
    fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16
...
>
    <div
        class="
      relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200
