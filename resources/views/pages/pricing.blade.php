    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h1 class="mt-4 mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">A default pricing page you can customize</h1>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Bring your own tailwind template, and change the source code directly. Or keep initial design and simply change words.</p>
            </div>
