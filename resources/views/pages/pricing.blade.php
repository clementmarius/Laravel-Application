    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h1 class="mt-4 mb-4 text-4xl tracking-tight font-extrabold text-gray-900">A default pricing page you can customize</h1>
                <p class="mb-5 font-light text-gray-500 sm:text-xl">Bring your own tailwind template, and change the source code directly. Or keep initial design and simply change words.</p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 ">
                <!-- Pricing Card -->
                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow xl:p-8 mt-8">
